...
Q_IMPORT_QML_PLUGIN(designeffectsPlugin)
Q_IMPORT_QML_PLUGIN(QtQuick_Studio_LogicHelperPlugin)
Q_IMPORT_QML_PLUGIN(QtQuickUltralite_LayersPlugin)
Q_IMPORT_QML_PLUGIN(QtQuickUltralite_ExtrasPlugin)
...
Q_IMPORT_QML_PLUGIN(TransitionItemPlugin)
Q_IMPORT_QML_PLUGIN(io_qt_EventSimulatorPlugin)
Q_IMPORT_QML_PLUGIN(EventListPlugin)
Q_IMPORT_QML_PLUGIN(ZegaryContentPlugin)
Q_IMPORT_QML_PLUGIN(ZegaryPlugin)

const char mainQmlFile[] = "qrc:/qt/qml/ZegaryContent/App.qml";
